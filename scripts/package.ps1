...
# Set Chocolatey package source to the Proget server
choco source add -n proget -s http://nuget.tjgdev.ds:7272/nuget/Chocolatey --priority 1

# Global accept all licenses in Chocolatey so you no longer need to type -y after every "choco install"
